...
class SettingsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        childFragmentManager.beginTransaction()
            .replace(binding.layoutPreferences.id, PreferencesFragment()).commit()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
            ...
            registerForActivityResult(ActivityResultContracts.PickVisualMedia()) { uri ->
                if (uri != null) {
                    ...
                    lifecycleScope.launch {
                        user.update()
                        binding.imageviewPhoto.load(
                            user.photoUrl ?: R.drawable.ic_default_profile_photo
                        )
                    }
                }
            }
        ...
        binding.buttonEditPhoto.visibility = if (user.provider == CurrentUser.Provider.EMAIL) {
            View.VISIBLE
        } else {
            View.GONE
        }
        ...
        binding.imageviewPhoto.load(user.photoUrl ?: R.drawable.ic_default_profile_photo)
    }
